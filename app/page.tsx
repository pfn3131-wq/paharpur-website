...
export default function Home() {
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', margin: '0', backgroundColor: '#f4f7f6', color: '#333', minHeight: '100vh', paddingBottom: '20px' }}>
      ...
      <footer style={{ textAlign: 'center', fontSize: '12px', color: '#888', marginTop: '20px' }}>© 2026 Paharpur Fiber Net & LPG Gas</footer>
    </div>
  );
}
